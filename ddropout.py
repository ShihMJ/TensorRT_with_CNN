    ...
    for node in input_nodes:
        ...
        if new_node.name.startswith(output_after):
            ...
            for node_name in new_node.input:
                #print node_name
                if node_name.startswith(drop_scope):
...
def main():
    ...
    output_graph_def = strip(input_graph_def, u'dropout_1/Identity', u'max_pooling2d_1/MaxPool', u'conv2d_2/convolution', u'is_training_pl')
